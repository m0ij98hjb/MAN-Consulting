    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] font-cairo" dir={isRTLLang ? "rtl" : "ltr"}>
      ...
      <section className="image-hero relative h-screen min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-6 max-w-7xl pt-24 md:pt-28">
          <div className={isRTLLang ? "text-right" : "text-left"} data-aos="fade-up">
            {/* Badge */}
            <div className="inline-flex items-center gap-2.5 bg-white/5 border border-[#D4A843]/30 rounded-full px-5 py-2 mb-8">
              <div className="w-1.5 h-1.5 rounded-full bg-[#D4A843] animate-pulse" />
              <span className="text-[#D4A843] text-xs font-bold tracking-widest uppercase">{content.badge}</span>
            </div>
            ...
            <p className="text-[#D4A843] text-lg md:text-2xl font-bold mb-6">{content.subtitle}</p>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center gap-3 bg-[#D4A843] hover:bg-[#D9A62A] text-[#1F2937] font-black px-8 py-4 rounded-full text-base transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(212,168,67,0.3)]"
              >
                {content.ctaBtn}
              ...
              <a
                href="#offerings"
                className="inline-flex items-center gap-3 border-2 border-white/30 text-white font-bold px-8 py-4 rounded-full text-base transition-all duration-300 hover:border-[#D4A843] hover:text-[#D4A843]"
              >
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16" data-aos="fade-up">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-[#D4A843] font-bold tracking-widest uppercase text-xs">{content.badge}</span>
              <span className="h-px w-8 bg-[#D4A843]" />
            </div>
            <h2 className="text-3xl md:text-4xl font-black text-[var(--foreground)] font-heading mb-4">
              {content.offeringsTitle}
            </h2>
            <div className="w-20 h-1 bg-gradient-to-r from-[#D4A843] to-[#E8C46A] mx-auto rounded-full" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {content.offerings.map((item, i) => (
              <div
                key={i}
                className="flex items-start gap-4 bg-[var(--background)] p-5 rounded-2xl border border-[var(--card-border)] hover:border-[#D4A843]/30 transition-all duration-300 group"
                data-aos="fade-up"
                data-aos-delay={i * 70}
              >
                <div className="w-8 h-8 rounded-lg bg-[#D4A843]/10 border border-[#D4A843]/20 flex items-center justify-center shrink-0 group-hover:bg-[#D4A843]/20 transition-colors mt-0.5">
                  <CheckCircle2 className="text-[#D4A843]" size={16} />
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {content.advantages.map((adv, i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-[var(--card-bg)] rounded-2xl p-6 border border-[var(--card-border)] hover:border-[#D4A843]/30 transition-all duration-300 group text-center"
                  data-aos="fade-up"
                  data-aos-delay={i * 100}
                >
                  <div className="w-14 h-14 rounded-2xl bg-[#D4A843]/10 border border-[#D4A843]/20 flex items-center justify-center mx-auto mb-5 group-hover:bg-[#D4A843]/20 transition-colors">
                    <Icon className="text-[#D4A843]" size={26} />
                  </div>
                  <h3 className="font-black text-lg text-[#D4A843] mb-3">{adv.title}</h3>
      ...
      <section className="py-24 bg-black/40 border-y border-white/5">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center max-w-2xl mx-auto mb-16" data-aos="fade-up">
            ...
            <div className="w-16 h-1 bg-gradient-to-r from-[#D4A843] to-[#E8C46A] mx-auto rounded-full" />
          </div>
            ...
            {(content.projects || []).map((proj, idx) => (
              ...
              >
                ...
                <div className={`absolute bottom-4 ${isRTLLang ? "right-4" : "left-4"} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}>
                  <span className="text-[#D4A843] text-xs font-bold uppercase tracking-widest bg-black/60 px-3 py-1.5 rounded-full border border-[#D4A843]/20">
      ...
      <section className="py-28 bg-[#060E1A] relative overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-6">
          <div
            className="max-w-4xl mx-auto rounded-3xl border-2 border-[#D4A843]/25 bg-gradient-to-br from-[#D4A843]/10 via-[#D4A843]/5 to-transparent p-10 md:p-16 text-center shadow-[0_0_100px_rgba(212,168,67,0.12),inset_0_1px_0_rgba(212,168,67,0.15)]"
            data-aos="fade-up"
          >
            {/* Title */}
            ...
            {/* Divider */}
            <div className="w-20 h-[2px] bg-gradient-to-r from-transparent via-[#D4A843] to-transparent mx-auto mb-10" />

            {/* Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-3 bg-[#D4A843] hover:bg-[#D9A62A] text-[#1F2937] font-black px-10 py-4 rounded-full text-base transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_0_35px_rgba(212,168,67,0.4)] hover:shadow-[0_0_50px_rgba(212,168,67,0.55)]"
              >
                <Phone size={18} />
                {content.ctaBtn}
              </Link>
              <Link
                href="/projects"
                className="inline-flex items-center justify-center gap-3 border-2 border-[#D4A843]/35 text-[#D4A843] font-bold px-10 py-4 rounded-full text-base transition-all duration-300 hover:bg-[#D4A843]/10 hover:border-[#D4A843]/60"
              >
