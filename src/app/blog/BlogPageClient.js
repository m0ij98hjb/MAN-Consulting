            ...
            {BLOG_POSTS.map((post) => (
              ...
              >
                <div className="relative h-52 w-full overflow-hidden">
                  ...
                  />
                  <span className="absolute top-4 start-4 bg-[#F2B233] text-[#1F2937] text-[11px] font-bold uppercase tracking-wide px-3 py-1 rounded-full">
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <h2 className="text-lg font-bold text-[#1F2937] leading-snug mb-3 group-hover:text-[#F2B233] transition-colors">
                    {post.title[lang] || post.title.en}
                  </h2>
                  <p className="text-[#4B5563] text-sm leading-relaxed mb-5 flex-1">
                    {post.excerpt[lang] || post.excerpt.en}
                  </p>
                  <span className="inline-flex items-center gap-1.5 text-[#F2B233] text-sm font-bold">
