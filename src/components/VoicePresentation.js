    ...
    <>
      ...
      >
        ...
        <AnimatePresence>
          {showVolumeControl && (
            <motion.div
              ...
              exit={{ opacity: 0, y: 10 }}
              className="flex flex-col items-center gap-2 bg-[var(--card-bg)]/95 p-4 rounded-2xl shadow-lg border border-[rgba(212,168,67,0.2)]"
            >
              <input
                type="range"
                min="0"
                ...
                className="w-20 h-1 transform -rotate-90 origin-left accent-[#D4A843]"
        ...
        <motion.button
          ...
          className="relative p-5 rounded-full shadow-lg transition-all duration-300 flex items-center justify-center cursor-pointer bg-[var(--secondary)] text-[var(--foreground)] shadow-[0_0_20px_rgba(212,168,67,0.4)]"
