  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 rounded-full transition-all duration-500 ${
        isMusicPlaying
          ? 'bg-[#D4A843]/10 shadow-[0_0_25px_rgba(212,168,67,0.3)] border border-[#D4A843]/40'
      ...
      <AnimatePresence>
        {isMusicPlaying && (
          <>
            <motion.div
              className="absolute inset-[-4px] rounded-full border border-[#D4A843]/30"
            ...
            />
            <motion.div
              className="absolute inset-[-2px] rounded-full border border-[#D4A843]/20"
          ...
          {isMusicPlaying ? (
            ...
            >
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11 5L6 9H2V15H6L11 19V5Z" fill="#D4A843" fillOpacity="0.3" stroke="#D4A843" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                {/* Sound wave lines */}
                <motion.path
      ...
      <div className={`absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap text-[10px] font-bold uppercase tracking-wider transition-all duration-300 opacity-0 group-hover:opacity-100 ${
        isMusicPlaying ? 'text-[#D4A843]' : 'text-white/50'
      }`}>
