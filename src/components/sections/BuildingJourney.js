...
const TX = {
  ...
  companyBadge: { ar: "شركة MAN للاستشارات الهندسية", en: "MAN Engineering Consultancy", hi: "MAN जनरल कॉन्ट्रैक्टिंग", ru: "MAN Engineering Consultancy", de: "MAN Engineering Consultancy", fr: "MAN Engineering Consultancy", es: "MAN Engineering Consultancy", tr: "MAN Engineering Consultancy", ur: "MAN جنرل کنٹریکٹنگ", zh: "MAN 总承包" },
};
