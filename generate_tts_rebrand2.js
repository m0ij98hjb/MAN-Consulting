...
تُعَدُّ شركة M.A.N. للاستشارات الهندسية علامة هندسية متميزة في مجال الاستشارات والتصميم الهندسي، تأسست في مدينة جُدَّة بالمملكة العربية السعودية، وأثبتت بِخِبْرَة تَمْتَدُّ منذ عام 1986 حضورًا قويًا في السوق الهندسي، من خلال تنفيذ عِدَّة مشاريع تُكُلِّلَتْ بالنجاح بفضل الله.

يقود هذه الشركة المتميزة رئيس مجلس الإدارة المُهَنْدِس، مروان أحمد نَاظِر، صاحب الخبرة الهندسية الواسعة، وتحت إشرافه المباشر تَعْمَلُ الشركة على تحقيق أعلى معايير الجودة في كل مشروع تتولى تنفيذه.

تُقَدِّمُ شركة M.A.N. للاستشارات الهندسية باقة متكاملة من الخدمات الهندسية الاحترافية، تَشْمَلُ: التصميم المعماري بأفكار مبتكرة وحلول عصرية، وإدارة المشاريع بإشراف متكامل على جميع مراحل التنفيذ، فضلًا عن التصميم الداخلي والديكور والتشطيب بأعلى مستوى من الجودة والأناقة.

شكرًا لزيارتكم، شركة M.A.N. للاستشارات الهندسية، حيث تَتَحَوَّلُ رؤيتكم إلى واقع هندسي متميز.`,
  },
  {
    code: 'en',
