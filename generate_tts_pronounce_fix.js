// Regenerates the 8 non-Arabic presentation MP3s with "MAN" written so the
// TTS engine spells it out letter-by-letter instead of reading it as the
// English word "man". Latin-script languages (+ Chinese) use "M.A.N.",
// matching the standard initialism-spelling convention. Hindi and Urdu use
// native-script phonetic letter names, mirroring the crisp/short-vowel fix
// confirmed for Arabic ("إمْ - إي - إنْ").
// Voice/lang/rate per language are unchanged from generate_tts_all.js.
...
M.A.N. Engineering Consultancy is a distinguished engineering brand in engineering consulting and design, established in Jeddah, Saudi Arabia. Within a short period, it has built a strong presence in the engineering market by successfully delivering numerous projects, thanks to God.
...
M.A.N. Engineering Consultancy ist eine herausragende Ingenieurmarke im Bereich technische Beratung und Design, gegründet in Jeddah, Saudi-Arabien. In kurzer Zeit hat sie sich durch die erfolgreiche Umsetzung zahlreicher Projekte eine starke Präsenz auf dem Ingenieurmarkt erarbeitet.
...
M.A.N. Engineering Consultancy es una destacada marca de ingeniería en el ámbito de la consultoría y el diseño de ingeniería, fundada en Yeda, Arabia Saudita. En poco tiempo, ha logrado una fuerte presencia en el mercado de la ingeniería mediante la ejecución exitosa de numerosos proyectos.
...
M.A.N. Engineering Consultancy est une marque d'ingénierie distinguée dans le domaine du conseil et de la conception en ingénierie, fondée à Djeddah, en Arabie saoudite. En peu de temps, elle a su s'imposer solidement sur le marché de l'ingénierie grâce à la réalisation réussie de nombreux projets.
...
M.A.N. Engineering Consultancy, mühendislik danışmanlığı ve tasarımı alanında öne çıkan bir mühendislik markasıdır ve Suudi Arabistan'ın Cidde şehrinde kurulmuştur. Kısa bir süre içinde, birçok projeyi başarıyla tamamlayarak mühendislik pazarında güçlü bir varlık oluşturmuştur.
...
M.A.N.工程咨询公司是工程咨询与设计领域一个卓越的工程品牌，创立于沙特阿拉伯吉达市。在短时间内，公司凭借成功完成的多个项目，在工程市场上建立了强大的影响力。
...
एम् - ए - एन् इंजीनियरिंग कंसल्टेंसी इंजीनियरिंग परामर्श और डिज़ाइन के क्षेत्र में एक उत्कृष्ट इंजीनियरिंग ब्रांड है, जिसकी स्थापना सऊदी अरब के जेद्दा शहर में हुई थी। बहुत ही कम समय में, कंपनी ने कई परियोजनाओं को सफलतापूर्वक पूरा करके इंजीनियरिंग बाज़ार में एक मजबूत उपस्थिति स्थापित की है।
...
ایمْ - ای - اینْ انجینئرنگ کنسلٹنسی انجینئرنگ مشاورت اور ڈیزائن کے شعبے میں ایک ممتاز انجینئرنگ برانڈ ہے، جس کی بنیاد سعودی عرب کے شہر جدہ میں رکھی گئی۔ بہت کم عرصے میں، کمپنی نے متعدد منصوبوں کو کامیابی سے مکمل کر کے انجینئرنگ مارکیٹ میں مضبوط موجودگی قائم کی ہے۔
...
async function run() {
  ...
  console.log('All 8 presentation audio files regenerated with the MAN pronunciation fix.');
}
